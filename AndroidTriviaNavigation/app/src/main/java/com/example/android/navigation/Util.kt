...
import com.example.android.navigation.database.Adatb
 ...
 */
fun formatNights(nights: List<Adatb>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTimeMilli != it.startTimeMilli) {
                ...
                append("\t${convertNumericQualityToString(it.whoWon, resources)}<br>")
